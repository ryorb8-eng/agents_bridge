...
> **Cross-PC via SSH** is intentionally not built yet — the user will teach the
> tunnel skill. Until then, supply a reachable CDP `host:port`.
...
opens a specific ChatGPT conversation, and reads the last assistant reply. Run:

```bash
npx tsx bridge-cdp.ts
# override: BRIDGE_CDP=http://host:9222 BRIDGE_CHAT_URL=https://chatgpt.com/c/... npx tsx bridge-cdp.ts
```

- Reads `https://chatgpt.com/c/6a55d793-7190-83ec-bef1-2dedc49cf737` by default (set
