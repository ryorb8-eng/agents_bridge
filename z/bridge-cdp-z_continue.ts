...
/**
 * bridge-cdp-z_continue.ts — TRANSPORT layer untuk agents_bridge (Z Web UI / chat.z.ai).
 *
 * Sama dengan bridge-cdp-z_new.ts, tapi default-nya MENUJU conversation yang SUDAH
 * ADA (d63fd4ea-d38f-499b-a2b4-96e92e134186) — dipakai untuk melanjutkan chain
 * brainstorm / diskusi yang sedang berjalan (mis. /webchain-z yang menambah
 ...
 * lokal atas instruksi remote AI, TIDAK membaca secret. Balasan Z adalah
...
const CHAT_URL =
  ...
  'https://chat.z.ai/c/d63fd4ea-d38f-499b-a2b4-96e92e134186';
...
// `.copy-response-button` (user messages tidak punya). getLastReplyZ() memilih
// bubble terakhir yang mengandung `.copy-response-button`.
